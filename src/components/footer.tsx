...
export default function SimpleBottomNavigation() {
  ...
  const handleChange = (
    ...
    newValue: 'TMDB Credits' | 'Davids portfolio'
  ) => {
    setValue(newValue)
  }
    ...
    <Box className="footer">
      ...
      >
        <BottomNavigationAction
          ...
          value="TMDB Credits"
          label="This product uses the TMDB API but is not endorsed or certified by TMDB."
        ...
        <Tooltip title="Go to Davids portfolio">
          <Link href="https://davidronnlidportfolio.netlify.app/">
            <BottomNavigationAction
              value="Davids portfolio"
              icon={
                <img
                  alt="David Rönnlid smiling confidently"
                  src={DRConfTransparent}
                  className="footerIcon dRSC"
                />
              }
            />
          </Link>
